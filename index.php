  ...
  <body>
    ...
    <div class="container-narrow">
      ...
      <div class="jumbotron">
        ...
        <p class="lead">Open Voice Data Project (OVDP) is a technical effort to host data and collection tools for disphonia (voice disorder) data sets.</p>
        <p class="lead">Our first collection project focuses on Parkinson's Disorder.</p>
        <p class="lead"><a href="#">Read more about Parkinson's</a>.</p>
